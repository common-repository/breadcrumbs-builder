...
global $sgbb;
$sgbb->includeLib('BreadcrumbList');

class SGBB_Breadcrumb extends SGBB_BreadcrumbList
{
	protected $id = '';
	...
	public function __construct($id)
	{
		...
		parent::__construct(array(
			'singular'=> 'wp_'.$sgbb->prefix.'_'.$id, //singular label
			'plural' => 'wp_'.$sgbb->prefix.'_'.$id.'s', //plural label
			'ajax' => false
		));
	}
	...
	{
		global $sgbb;
		$this->tablename = $sgbb->tablename($tablename);
	}
