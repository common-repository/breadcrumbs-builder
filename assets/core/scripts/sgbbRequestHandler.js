function sgbbRequestHandler(action, data, params){
	this.action = action;
	this.url = '';
	this.data = data;
	this.callback = '';
...
if(typeof ajaxurl === 'undefined') {
	ajaxurl = sgbb_ajaxurl;
	this.url = ajaxurl;
}
sgbbRequestHandler.prototype.prepareData = function() {
	this.url = ajaxurl;
...
sgbbRequestHandler.prototype.run = function(){
	var that = this;
	that.prepareData();
	var settings = {
		url: that.url,
